...
#url = requests.get("https://itunes.apple.com/search?parameterkeyvalue", params = make_public_task)



@app.route('/movie/<moviename>')
def homepage(moviename):
...
#For example, if you go to the URL 'http://localhost:5000/movie/ratatouille', you should seesomething like the data shown in the included file sample_ratatouille_data.txt,
# which contains data about the animated movie Ratatouille. 
#However, if you go to the url http://localhost:5000/movie/titanic, you should get different data, and if you go to the url 'http://localhost:5000/movie/dsagdsgskfsl' 
